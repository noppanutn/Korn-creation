...
if(isset($_POST['First_Name'])){
  ...
  $id = $_SESSION['u_id'];
  $addressid = $_SESSION['u_adid'];
  $address = $_POST['Address'];
  $city = $_POST['City'];
  $country = $_POST['Country'];
  $zipcode = $_POST['Zip_Code'];
  //echo "something";
  $q = "UPDATE staff SET USER_TITLE='$title'
  , USER_FNAME = '$fname'
  , USER_LNAME = '$lname'
  , USER_EMAIL = '$email'
  , USER_PHONE = '$phone'
  ...
  $q = "UPDATE useraddress SET ADDRESS='$address'
  , CITY ='$city'
  , COUNTRY ='$country'
  , ZIPCODE ='$zipcode'
...
<tr>
<td>FIRST NAME</td>
<td><input type="text" name="First_Name" value="<?php echo $_SESSION['u_fname'] ?>" maxlength="30"/>
...
<tr>
<td>LAST NAME</td>
<td><input type="text" name="Last_Name" value="<?php echo $_SESSION['u_lname'] ?>" maxlength="30"/>
(max 30 characters a-z and A-Z)
</td>
</tr>
...
<td>TITLE</td>
<td>
MR. <input type="radio" name="Title" value="Mr."  <?php if($_SESSION['u_title']=='Mr.'){ echo 'checked';}?>>
MS. <input type="radio" name="Title" value="Ms."  <?php if($_SESSION['u_title']=='Ms.'){ echo 'checked';}?>/>
</td>
</tr>
...
<tr>
<td>EMAIL Address</td>
<td><input type="text" name="Email_Id" value="<?php echo $_SESSION['u_email'] ?>" maxlength="100" /></td>
</tr>
...
<td>MOBILE NUMBER</td>
<td>
<input type="text" name="Mobile_Number" value="<?php echo $_SESSION['u_phone'] ?>" maxlength="10" />
(10 digit number)
</td>
</tr>
...
<td><textarea name="Address" rows="4" cols="30"><?php echo $_SESSION['u_address'] ?></textarea></td>
</tr>

<!----- City ---------------------------------------------------------->
<tr>
<td>CITY</td>
<td><input type="text" name="City" maxlength="30" value="<?php echo $_SESSION['u_city'] ?>">
(max 30 characters a-z and A-Z)
</td>
</tr>
...
<tr>
<td>COUNTRY</td>
<td><input type="text" name="Country" maxlength="30" value="<?php echo $_SESSION['u_country'] ?>">
(max 30 characters a-z and A-Z)
</td>
</tr>
...
<tr>
<td>ZIP CODE</td>
<td><input type="text" name="Zip_Code" maxlength="6" value="<?php echo $_SESSION['u_zipcode'] ?>">
(6 digit number)
</td>
</tr>
